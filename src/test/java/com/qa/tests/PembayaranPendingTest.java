...
public class PembayaranPendingTest extends BaseTest{
...
//		introPage = new IntroScreenPage();
	...
	public void PembayaranPending() {
		...
		pembayaranPage.pressBtnPending();
		...
		String expectedMethod = getStrings().get("pembayaran_pending");
