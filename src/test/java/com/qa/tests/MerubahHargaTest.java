...
public class MerubahHargaTest extends BaseTest{
...
//		introPage = new IntroScreenPage();
	...
	@Test(priority = 2)
	public void merubahHarga() {
		penjualanPage.pilihKategori1();
		penjualanPage.TambahKeranjang1();
		itemPopUp = penjualanPage.PilihKeranjang1();
		itemPopUp.enterHargaSatuan(getStrings().get("Price_unit"));
		penjualanPage = itemPopUp.pressSaveBtn();
		
		String expectedPrice = getStrings().get("expected_Price_unit");
		String actualPrice = penjualanPage.getHarga();
