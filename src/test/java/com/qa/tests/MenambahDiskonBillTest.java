...
public class MenambahDiskonBillTest extends BaseTest{
...
//		introPage = new IntroScreenPage();
	...
	public void menambahDiskonBill() {
		...
		diskonBillPage = penjualanPage.pressLblDiskon();
		penjualanPage = diskonBillPage.diskonSepuluhPersen();
		
		String expectedDiskon = getStrings().get("diskon_bill");
		String actualDiskon = penjualanPage.getStatusDiskon();
		Assert.assertEquals(actualDiskon, expectedDiskon);
