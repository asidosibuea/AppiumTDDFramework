...
public class MenambahCatatanTest extends BaseTest {
...
//		introPage = new IntroScreenPage();
	...
	@Test(priority = 2)
	public void menambahCatatan() {
		penjualanPage.pilihKategori1();
		penjualanPage.TambahKeranjang1();
		itemPopUp = penjualanPage.PilihKeranjang1();
		itemPopUp.enterNote(getStrings().get("note_item"));
		penjualanPage = itemPopUp.pressSaveBtn();
		
		String expectedNote = getStrings().get("note_item");
		String actualNote = penjualanPage.getStatusNote();
