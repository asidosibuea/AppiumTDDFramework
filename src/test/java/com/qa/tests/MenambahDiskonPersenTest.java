...
public class MenambahDiskonPersenTest extends BaseTest{
...
//		itemPopUp.selectDiskonPersen();
		itemPopUp.enterDiskonPersen(getStrings().get("discount_percent"));
		penjualanPage = itemPopUp.pressSaveBtn();
		
		String expectedDsikon = getStrings().get("expected_diskon_persen");
		String actualDiskon = penjualanPage.getDiskonPersen();
