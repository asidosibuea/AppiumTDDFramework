...
public class PembayaranTransferTest extends BaseTest {
...
//		introPage = new IntroScreenPage();
	...
	@Test(priority = 2)
	public void PembayaranTransfer() {
		...
		pembayaranPage.pressBtnTransfer();
		...
		pembayaranPage.enterNamaRek(getStrings().get("customer_name"));
		pembayaranPage.enterNoRek(getStrings().get("rek_number"));
		pembayaranPage.enterBankName(getStrings().get("bank_name"));
		...
		String expectedMethod = getStrings().get("pembayaran_transfer");
