...
public class CekServiceTest extends BaseTest{
...
//		introPage = new IntroScreenPage();
	...
	public void menambahDiskonBill() {
		...
		String expectedService = getStrings().get("cek_service");
		String actualService = penjualanPage.getStatusService();
		
		Assert.assertEquals(actualService, expectedService);
//		penjualanPage.labelService();
	}
